...
/* Masquer l'en-tête complet de Streamlit (boutons de déploiement, GitHub, menu) */
    header[data-testid="stHeader"] {
        display: none !important;
    }
    
    /* Supprimer la marge supérieure créée par l'en-tête masqué */
    .main .block-container {
        padding-top: 1rem !important;
    }
    
    /* Masquer le footer par la même occasion si ce n'est pas déjà fait */
